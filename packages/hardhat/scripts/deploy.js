...
const main = async () => {
  ...
  const yourContract = await deploy("PolyAlloyToken"); // <-- add in constructor args like line 19 vvvv
  ...
  */
  ...
  const yourContract = await deploy("PolyAlloyToken", [], {
